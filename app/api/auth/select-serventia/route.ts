...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const log = await getLogger({ userId: session.user.id, serventiaId: body.serventiaId, action: 'select_serventia' })
    log.error({ err }, 'Falha inesperada ao selecionar serventia')
