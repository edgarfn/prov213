...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const log = await getLogger({ userId: session.user.id, serventiaId: membro.serventiaId, action: 'exportar_auditoria' })
    log.error({ err, formato }, 'Falha inesperada ao exportar log de auditoria')
