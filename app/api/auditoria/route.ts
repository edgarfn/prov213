...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const log = await getLogger({ userId: session.user.id, serventiaId: membro.serventiaId, action: 'consultar_auditoria' })
    log.error({ err }, 'Falha inesperada ao consultar log de auditoria')
