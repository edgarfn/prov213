...
export type AcaoAuditoria =
  ...
  // Recomendação Técnica e Decisão do Controlador (governança de TI/LGPD)
  | 'RECOMENDACAO_CRIADA'
  | 'RECOMENDACAO_ANALISE_RISCO_REGISTRADA'
  | 'RECOMENDACAO_PARECER_DPO_REGISTRADO'
  | 'RECOMENDACAO_DECIDIDA'
  | 'RECOMENDACAO_ORDEM_IMPLEMENTACAO_EMITIDA'
  | 'RECOMENDACAO_EXECUCAO_REGISTRADA'
  | 'RECOMENDACAO_ACEITE_REGISTRADO'
  | 'RECOMENDACAO_DOCUMENTOS_ATUALIZADOS'
  | 'RECOMENDACAO_DOSSIE_GERADO'
  // Sistema
